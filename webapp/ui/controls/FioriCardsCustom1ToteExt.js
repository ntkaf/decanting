sap.ui.define([
    ...
    "sap/m/Button",
    "sap/m/StepInput"
], function(FioriCardsCustom1ToteExt,VBox,Text,Title,ObjectNumber,FlexItemData,Button,StepInput) {
	"use strict";

	return FioriCardsCustom1ToteExt.extend("com.westernacher.decanting.ui.controls.FioriCardsCustom1ToteExt", {
        metadata: {
			 properties : {
                "title": {type: "string"},
        ...
        init:function(){
             FioriCardsCustom1ToteExt.prototype.init.apply(this,arguments);
        },
		onBeforeRendering:function (){
            FioriCardsCustom1ToteExt.prototype.onBeforeRendering.apply(this,arguments);
            ...
            this._oVbox = new VBox({
                ...
                width:"100%",
                items:[this._oTitle,this._oButtonTop]
            });
